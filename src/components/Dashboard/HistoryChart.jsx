...
const DOMAIN_CONFIG = {
  leadership_gouvernance: { label: "Leadership & Gouvernance" },
  organisation_securite: { label: "Organisation Sécurité" },
  gestion_risques: { label: "Gestion des Risques" },
  securite_rh: { label: "Sécurité RH" },
  gestion_actifs: { label: "Gestion des actifs informationnels" },
  gestion_acces: { label: "Gestion des Accès" }
};
